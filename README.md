...
The main objective of this project is to implement, using [AppJail](https://github.com/DtxdF/AppJail) and [Director](https://github.com/DtxdF/director), what the Wazuh team does in [Docker](https://github.com/wazuh/wazuh-docker), to easily deploy Wazuh and all its components on FreeBSD.
